...
@Table(
        ...
        uniqueConstraints = @UniqueConstraint(columnNames = {"category_id", "nom_attribut"})
)
@Getter
@Setter
@NoArgsConstructor
...
public class CategoryAttributeDefinition {
    ...
    @Column(name = "nom_attribut", nullable = false, length = 120)
    private String nomAttribut;

    @Enumerated(EnumType.STRING)
    @Column(name = "type_valeur", nullable = false, length = 20)
    private AttributeValueType typeValeur;
}
